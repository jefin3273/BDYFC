...
export default function Footer() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: submitError } = await supabaseBrowser.from("newsletter_subscribers").insert([
        {
          email,
          status: "active",
        },
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span>19, Hazarimal Somani Rd, Azad Maidan, Fort, Mumbai, Maharashtra 400001</span>
              </li>
